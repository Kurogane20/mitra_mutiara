...
<body>
                ...
                <div class="carousel-inner">
                    <div class="carousel-item active">
                        ...
                        <div class="py-5 row d-flex align-items-center">
                            <div class="banner-content col-lg-8 col-8 offset-2 m-lg-auto text-left py-5 pb-5">
                                ...
                                Solusi  <strong>IoT untuk Operasi </strong> 
                                  <br>yang Lebih Efisien
                              </h1>
                                <p class="banner-body text-white py-3 mx-0 px-0">
                                Kami menghadirkan solusi IoT yang inovatif untuk meningkatkan efisiensi, produktivitas, dan konektivitas bisnis Anda.  Kami mengubah bisnis Anda menjadi lebih cerdas.
                              </p>
                                <a class="banner-button btn rounded-pill btn-primary btn-lg px-4" href="#" role="button">Get Started</a>
                            </div>
                        </div>
                    ...
                    <div class="carousel-item">
                        ...
                        <div class="py-5 row d-flex align-items-center">
                            <div class="banner-content col-lg-8 col-8 offset-2 m-lg-auto text-left py-5 pb-5">
                                <h1 class="banner-heading h1 text-white display-3 mb-0 pb-5 mx-0 px-0 light-300 typo-space-line">
                                Solusi Cerdas untuk <br> <strong>Mengelola Limbah</strong>
                              </h1>
                                <p class="banner-body text-white py-3 mx-0 px-0">
                                Kami menghadirkan solusi IoT yang inovatif untuk meningkatkan efisiensi, produktivitas, dan konektivitas bisnis Anda.  Kami mengubah bisnis Anda menjadi lebih cerdas.
                              </p>
                    ...
                    <div class="carousel-item">
                        ...
                        <div class="py-5 row d-flex align-items-center">
                            <div class="banner-content col-lg-8 col-8 offset-2 m-lg-auto text-left py-5 pb-5">
                                <h1 class="banner-heading h1 text-white display-3 mb-0 pb-5 mx-0 px-0 light-300 typo-space-line">
                                Inovasi Teknologi untuk <br> <strong>Energi Bersih</strong>
                              </h1>
                                <p class="banner-body text-white py-3 mx-0 px-0">
                                Kami menghadirkan solusi IoT yang inovatif untuk meningkatkan efisiensi, produktivitas, dan konektivitas bisnis Anda.  Kami mengubah bisnis Anda menjadi lebih cerdas.
                              </p>
        ...
        <div class="container-fluid pb-3">
            <div class="row">
                ...
                <div class="service-heading col-10 col-lg-9 text-start float-end light-300">
                    <h2 class="h3 pb-4 typo-space-line">Layanan kami</h2>
                </div>
            </div>
            <p class="service-footer col-10 offset-2 col-lg-9 offset-lg-3 text-start pb-3 text-muted px-2">
            Berikut adalah layanan yang kami tawarkan, mencakup Produk dan Pengembangan serta produk dari Mitra Mutiara. Kami berkomitmen untuk memberikan solusi terbaik yang sesuai dengan kebutuhan Anda.
            </p>
        </div>
        ...
        <div class="service-tag py-5 bg-secondary">
            <div class="col-md-12">
                <ul class="nav d-flex justify-content-center">
                    ...
                    <li class="nav-item mx-lg-4">
                        <a class="filter-btn nav-link btn-outline-primary rounded-pill text-light px-4 light-300" href="#" data-filter=".produk-pengembangan">Produk dan Pengembangan</a>
                    </li>
                    <li class="filter-btn nav-item mx-lg-4">
                        <a class="filter-btn nav-link btn-outline-primary rounded-pill text-light px-4 light-300" href="#" data-filter=".produk-mitra">Produk Mitra Mutiara</a>
                    </li>
                    <!-- <li class="nav-item mx-lg-4">
    ...
    <div class="row gx-5 gx-sm-3 gx-lg-5 gy-lg-5 gy-3 pb-3 projects">
        ...
        <!-- Start Recent Work -->
        <div class="col-lg-4 col-md-6 col-sm-12 project produk-pengembangan">
            <a href="#" class="service-work card border-0 text-white shadow-sm overflow-hidden mx-5 m-sm-0">
                <img class="card-img" src="{{asset('page_assets/img/services-02.jpg') }}" alt="Card image">
                <div class="service-work-vertical card-img-overlay d-flex align-items-end">
                    <div class="service-work-content text-left text-light">
                        <span class="btn btn-outline-light rounded-pill mb-lg-3 px-lg-4 light-300">WTP & WWTP</span>
                        <p class="card-text">Perancangan dan pembangunan sistem IPAL</p>
                    </div>
                </div>
            </a>
        </div><!-- End Recent Work -->
        ...
        <div class="col-lg-4 col-md-6 col-sm-12 project produk-pengembangan">
            <a href="#" class="service-work card border-0 text-white shadow-sm overflow-hidden mx-5 m-sm-0">
                <img class="card-img" src="{{asset('page_assets/img/services-04.jpg') }}" alt="Card image">
                <div class="service-work-vertical card-img-overlay d-flex align-items-end">
                    <div class="service-work-content text-left text-light">
                        <span class="btn btn-outline-light rounded-pill mb-lg-3 px-lg-4 light-300">IoT Limbah & SPARING</span>
                        <p class="card-text">Supply dan Installasi SPARING</p>
                    </div>
                </div>
            </a>
        </div><!-- End Recent Work -->
        ...
        <!-- Start Recent Work -->
        <div class="col-lg-4 col-md-6 col-sm-12 project produk-mitra">
            <a href="#" class="service-work card border-0 text-white shadow-sm overflow-hidden mx-5 m-sm-0">
                <img class="card-img" src="{{asset('page_assets/img/services-05.jpg') }}" alt="Card image">
                <div class="service-work-vertical card-img-overlay d-flex align-items-end">
                    <div class="service-work-content text-left text-light">
                        <span class="btn btn-outline-light rounded-pill mb-lg-3 px-lg-4 light-300">ENGINEERING, PROCUREMENT, & CONSTRUCTION</span>
                        <p class="card-text">Jasa EPC / Engineering, Procurement and Construction</p>
                    </div>
                </div>
            </a>
        </div><!-- End Recent Work -->
        ...
        <div class="container py-5">
            <div class="row d-flex justify-content-center text-center">
                ...
                <div class="col-lg-7 col-12 text-light pt-2">
                    ...
                    <p class="light-300">Let's view what we have done</p>
                </div>
            ...
            <div class="row gy-5 g-lg-5 mb-4">
                ...
                <div class="col-md-4 mb-3">
                    <a href="#" class="recent-work card border-0 shadow-lg overflow-hidden">
                        <img class="recent-work-img card-img" src="{{asset('page_assets/img/recent-work/01.png') }}" alt="Card image">
                        <div class="recent-work-vertical card-img-overlay d-flex align-items-end">
                            <div class="recent-work-content text-start mb-3 ml-3 text-dark">
                                <h3 class="card-title light-300">Instalasi IPAL</h3>
                                <p class="card-text">PT SIMBA Indosnack Makmur</p>
                            </div>
                        </div>
                    </a>
                </div><!-- End Recent Work -->
                ...
                <div class="col-md-4 mb-3">
                    <a href="#" class="recent-work card border-0 shadow-lg overflow-hidden">
                        <img class="recent-work-img card-img" src="{{asset('page_assets/img/recent-work/02.png') }}" alt="Card image">
                        <div class="recent-work-vertical card-img-overlay d-flex align-items-end">
                            <div class="recent-work-content text-start mb-3 ml-3 text-dark">
                                <h3 class="card-title light-300">Instalasi WRU</h3>
                                <p class="card-text">Batalion 400 KODAM IV Diponegoro</p>
                            </div>
                        </div>
                    </a>
                </div><!-- End Recent Work -->
                ...
                <div class="col-md-4 mb-3">
                    <a href="#" class="recent-work card border-0 shadow-lg overflow-hidden">
                        <img class="recent-work-img card-img" src="{{asset('page_assets/img/recent-work/03.png') }}" alt="Card image">
                        <div class="recent-work-vertical card-img-overlay d-flex align-items-end">
                            <div class="recent-work-content text-start mb-3 ml-3 text-dark">
                                <h3 class="card-title light-300">Instalasi WRU</h3>
                                <p class="card-text">SMKN 66 Jakarta</p>
                            </div>
                        </div>
                    </a>
                </div><!-- End Recent Work -->
                ...
                <div class="col-lg-3 col-md-4 my-sm-0 mt-4">
                    <h3 class="h4 pb-lg-3 text-light light-300">Our Company</h2>
                        <ul class="list-unstyled text-light light-300">
                            ...
                            <li class="pb-2">
                                <i class='bx-fw bx bxs-chevron-right bx-xs'></i><a class="text-decoration-none text-light py-1" href="/work">Work</a>
                            </li>                           
                            <li class="pb-2">
