...
<head>
  ...
  <title>{{ $title ?? "Mitra Mutiara" }} | {{ auth()->user()->name }}</title>
...
<div class="wrapper">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="{{ route('home') }}" class="brand-link">
      ...
      <span class="brand-text font-weight-light">{{ $title ?? "Mitra Mutiara" }}</span>
    </a>
    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="{{ route('perusahaan.index') }}" class="nav-link {{ request()->routeIs('perusahaan.index') ? 'active' : '' }}">
